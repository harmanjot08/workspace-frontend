    ...
    const handleSendMessage = async (e) => {
        ...
        if (res.data) {
            sendMessage({
                ...
                fileUrl: fileData?.fileUrl || res.data.fileUrl,  // Local + API dono check karo
                fileName: fileData?.fileName || res.data.fileName,
                fileType: fileData?.fileType || res.data.fileType,
                        ...
                        {selectedFile && (
                            <div className="absolute -top-20 left-0 bg-slate-50 p-2 rounded-lg border border-slate-200">
                                ...
                                {selectedFile.fileType?.startsWith('image/') && (
                                    <img src={selectedFile.fileUrl} alt="preview" className="h-16 rounded" />
                                )}
                                <button
                                    type="button"
